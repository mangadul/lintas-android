...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        params.put("pref_proxy_domain", prefs.getString("pref_proxy_domain", "sip:lintasbpn.com"));
        params.put("pref_sip_user", prefs.getString("pref_sip_user", "dadang"));
        params.put("pref_sip_password", prefs.getString("pref_sip_password", "12345678"));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
        ...
        if (updated) {
            if (!device.updateParams(params)) {
                showOkAlert("RCDevice Error", "Preference not yet updated");
            }
        }
    }
